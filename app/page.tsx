          ...
          <div className="flex flex-col lg:grid lg:grid-cols-[1fr,auto] gap-8 lg:items-center">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">
                Drohnengestützte PV-Thermografie & Bauinspektionen in Hannover
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-gray-300">
                DIN/IEC-konform mit 24/48h Reaktionszeit.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-zinc-800 p-4 rounded-lg">
                  ...
                  <p className="text-gray-300 text-sm">
                    Präzise RTK-Positionierung für Brückeninspektionen und Vermessungen
                  </p>
                </div>
                <div className="bg-zinc-800 p-4 rounded-lg">
